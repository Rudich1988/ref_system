...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['phone_number'], name='customuser_phone_number_idx'), models.Index(fields=['invite_code'], name='customuser_invite_code_idx'), models.Index(fields=['referred_by'], name='customuser_referred_by')],
            },
            managers=[
